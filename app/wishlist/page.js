        ...
        <div className="2xl:w-[1500px] xl:w-[1000px]  lg:w-[880px]  md:w-[620px] sm:w-[550px] flex justify-between m-auto mt-20 2xl:mt-44 lg:mt-28 sm:mt-18  nav">
          <div className=" w-full">
            ...
            <div className="flex justify-end">
              <button onClick={clearWishlist} className="bg-black hover:bg-transparent hover:text-black hover:border border hover:border-black text-white py-1 px-4 2xl:py-3 2xl:px-8 rounded text-[8px] sm:text-[12px] lg:text-[14px] 2xl:text-[18px]  sm:my-3 2xl:my-4">
                Clear Wishlist
              </button>
            </div>
            {wishlist.length === 0 ? (
