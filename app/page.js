      ...
      <section>
        <div>
          ...
          <div className=" sm:pt-8  lg:pt-16" id="div3">
            <div className="flex flex-col mx-auto 2xl:w-[1200px]  xl:w-[850px] lg:w-[650px] sm:w-[500px] md:w-[600px]  2xl:py-28 xl:py-20">
              <div>
                <h1
              ...
              <div className=" mx-auto 2xl:w-[1200px]  xl:w-[850px] lg:w-[650px] sm:w-[500px] md:w-[600px] w-[280px]">
                <Carousel breakPoints={breakPoints}>
                  <div className="xl:w-[700px] 2xl:w-[1050px]  sm:mt-4 md:mt-5">
                    <div className="flex  lg:flex-row my-auto justify-between   2xl:mt-[65px]  ">
                      <div className="  lg:my-auto  2xl:w-[500px] xl:w-[265px] w-3/6 ">
                        <Image
                          src={Group11}
                          className="mx-auto 
                    w-[80px] h-[130px] sm:w-[170px] sm:h-[220px] md:w-[160px] md:h-[260px]
                     2xl:w-[426px] 2xl:h-[638px] xl:w-[360px] xl:h-auto lg:w-[400px] lg:h-auto"
                        />
                      </div>
                      <div className=" text-right  2xl:my-24  2xl:w-[565px] xl:w-[450px] w-4/6 sm:mt-3">
                        <div className="text-right items-end">
                          <h1
                            className=" text-white text-[12px] w-[120px] ml-[65px]  
                    sm:text-[20px] sm:leading-[25px] sm:mt-0 sm:w-[200px] sm:ml-[50px]
                    md:text-[25px] md:leading-[30px] md:ml-[120px]
                    lg:w-[200px] lg:text-[20px] lg:leading-[25px] lg:mt-16 lg:ml-36
                    xl:w-[240px] xl:text-[25px] xl:leading-[35px] xl:ml-[47%]
                    2xl:text-[40px] 2xl:leading-[50px] 2xl:w-[415px] 2xl:mt-0  2xl:ml-[27%]"
                            id="head2"
                          >
                ...
                sm:text-[12px] sm:leading-[16px] sm:my-0 sm:w-[240px] sm:ml-[11px]
                md:text-[13px] md:leading-[18px] md:my-5 md:ml-[0px] md:w-[330px]
                lg:text-[12px] lg:leading-[16px] lg:my-5 lg:w-[280px] lg:ml-[70px]
                xl:text-[16px] xl:leading-[25px] xl:my-7 xl:w-[400px] xl:ml-[50px]
                2xl:text-[18px] 2xl:leading-[28px] 2xl:my-7 2xl:w-[421px] 2xl:ml-[145px]"
                          >
                            חפש צרפתית איטליה או. מיזם מאמרשיחהצפה תנך אם, בדף
                            שמות משחקים אל, בדף ב יכול בויקיפדיה. או לערכים
                            אווירונאוטיקה אחר, כלל פיסיקה צרפתית אגרונומיה אל,
                          </p>
                          <div
                      ...
                      w-[100px] sm:[200px] lg:w-[161px]"
                       ...
                       lg:text-[16px] xl:text-[28px] 2xl:text-[34px] xl:leading-[50px] xl:w-[161px] "
                        ...
                        sm:mb-8 sm:py-[5px] sm:px-[20px]
                         lg:px-4   md:text-[18px] md:py-1 md:px-8 md:mt-3 md:mb-6  lg:text-[14px] lg:py-1  lg:my-3 xl:text-[18px] xl:py-1 xl:px-8 xl:my-3
            ...
            <div
              className="2xl:h lg:h-screen xl:py-16 lg:pt-10 pt-10"
              id="div4"
            >
              <div className="mx-auto 2xl:w-[1200px]  xl:w-[850px]  lg:w-[650px] sm:w-[500px] md:w-[600px]  w-[280px]">
                <h1
