          ...
          >
            ...
            <div className="flexEnd flex-col text-right">
              ...
              <button
                ...
                className="bg-black hover:bg-transparent hover:text-black hover:border border hover:border-black text-white  py-2 px-4 2xl:py-3 2xl:px-8 rounded text-[16px] 2xl:text-[18px] w-full mt-44 2xl:mt-44 "
              >
                Add to Cart
              </button>
              <button
