            ...
            <div className=" ">
              ...
              2xl:text-[50px] 2xl:leading-[60px]
               "
                ...
                <div className="flex md:flex-row mt-1 lg:flex-row my-auto justify-between  xl:mt-[35px] 2xl:mt-[50px]  ">
            ...
            <div className=" ">
              ...
              2xl:text-[50px] 2xl:leading-[60px]
               "
                ...
                <div className="flex  mt-1 lg:flex-row my-auto justify-between   xl:mt-[35px] 2xl:mt-[50px] ">
                  <div className=" lg:my-auto  2xl:w-[535px] w-2/6 sm:w-2/6 lg:w-2/6 md:mt-4 lg:mt-5 xl:mt-0">
                    <img
